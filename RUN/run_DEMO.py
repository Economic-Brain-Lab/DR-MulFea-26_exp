#!/Users/uqdrange/anaconda2/envs/dev/bin/python
# -*- coding: utf-8 -*-
...
def main(info, params, intro):
    ...
    dotCoherenceCircle = params['stim']['dotCoherenceCircle']['value']# coherence of the inner circle
    dotCoherenceRing = params['demo']['dotCoherenceRing']['value'] # coherence of the outer circle
    ...
    #===========================================================================
    trialNumber = 0
    for task in ['trainResponse',
                 'trainMotionDirection',
                 'trainTaskUnspeeded',
                 'trainTaskSpeeded']:
        ...
        # fbckDur = feedbackDuration
        fbckDur = feedbackDuration
        if task == 'trainResponse':
            fbckDur = np.nan
        trlDur = np.nan
        if task == 'trainTaskSpeeded':
        ...
        while True:
            ...
            responseDevice.update()
            #===================================================================
            # run trial, log it, and save data
            #===================================================================
            [dirsLeft,
             dirsRight,
             targetAngle,
